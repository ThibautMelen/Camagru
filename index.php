...
$addDomPost = $bdd->prepare('SELECT pseudo, avatar, picture, like_nb, post.id FROM member INNER JOIN post ON member.id = post.member_id ORDER BY `post`.`id` ASC LIMIT 12');
$addDomPost->execute();
